        ...
        <section className='cust-grid-stack bg-fit-drk py-5 overflow-hidden rounded-[0_0_3rem_3rem]'>
            ...
            <hgroup className="self-end flex flex-col gap-3 container mx-auto px-5 z-1">
                ...
                <div className="flex gap-3">
                    <ButtonPrimary label="Classes" type="link" href="/classes" icon={<LuArrowRight/>}/>
                    {
                        session ?
                            < ButtonPrimary label="Profile" type="link" href="/profile" icon={<LuArrowRight/>}/>
                            :
                            < ButtonPrimary label="Login" type="link" href="/auth/login" icon={<LuArrowRight/>}/>
                    }
